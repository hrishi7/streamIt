  ...
  axios
    .get(
      'https://api.themoviedb.org/3/tv/' +
        movieId +
        '?api_key=ca5d667528ca51e527d9e4f7830d97d2&language=en-US'
    )
    .then(response => {
          ...
          <h2>${movie.original_name}</h2>
            <ul class="list-group">
              ${
                ...
                `
                  : `
              <li class="list-group-item"><strong>Released On:</strong> ${formatDate(
                movie.first_air_date
              )}</li>
              `
              }
      ...
      <div class="row">
        <div class="well">
          ...
          <br><br>
            <a class="btn btn-default" target="_blank" href='https://openloadmovies.tv/tvseries/${(title = encodeURIComponent(
              movie.original_name
            ).replace(/%20/g, '-'))}'>Watch It</a>

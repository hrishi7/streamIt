...
function getMovies(searchText){
  axios.get('https://api.themoviedb.org/3/search/movie?api_key=ca5d667528ca51e527d9e4f7830d97d2&language=en-US&query='+searchText+'&page=1&include_adult='+adultFlag)
  .then((response) =>{
    ...
    output ='<h2 class="text-center">No Movie Available with this Name!! Please Try Another Name</h2>'
    $('#movies').html(output);
  }
  })
  .catch((err) =>{
